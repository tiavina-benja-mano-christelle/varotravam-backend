...
public class Transmission {
    ...
    public int getNbPage(Connection connection) throws SQLException{
        ...
        String sql = "SELECT count(*) / ? nb FROM transmission WHERE etat = ?";
    ...
    public Vector<Transmission> getAll(Connection connection, int start) throws SQLException{
        ...
        String sql = "SELECT * FROM transmission WHERE etat=? ORDER BY nom LIMIT ? OFFSET ?";
    ...
    public Vector<Transmission> getAll(Connection connection) throws SQLException{
        Vector<Transmission> vitesses = new Vector<>();
        boolean wasConnected = true;
        ...
        String sql = "SELECT * FROM transmission WHERE etat=? ORDER BY nom";
    ...
    public void save(Connection connection) throws SQLException {
        ...
        String sql = "INSERT INTO transmission(id, nom) VALUES (default, ?) ON CONFLICT(nom) DO UPDATE SET etat=? RETURNING id";
    ...
    public void update(Connection connection) throws SQLException {
        ...
        String sql = "UPDATE transmission SET nom=? WHERE id=?";
    ...
    public void delete(int id, Connection connection) throws SQLException, ClassNotFoundException {
        ...
        String sql = "UPDATE transmission SET etat=? WHERE id=?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
