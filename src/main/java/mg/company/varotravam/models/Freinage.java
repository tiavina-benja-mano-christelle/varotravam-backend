...
public class Freinage {
    ...
    public int getNbPage(Connection connection) throws SQLException{
        ...
        String sql = "SELECT count(*) / ? nb FROM freinage WHERE etat = ?";
    ...
    public Vector<Freinage> getAll(Connection connection, int start) throws SQLException{
        Vector<Freinage> vitesses = new Vector<>();
        boolean wasConnected = true;
        ...
        String sql = "SELECT * FROM freinage WHERE etat=? ORDER BY nom LIMIT ? OFFSET ?";
    ...
    public Vector<Freinage> getAll(Connection connection) throws SQLException{
        Vector<Freinage> vitesses = new Vector<>();
        boolean wasConnected = true;
        ...
        String sql = "SELECT * FROM freinage WHERE etat=? ORDER BY nom";
    ...
    public void save(Connection connection) throws SQLException {
        ...
        String sql = "INSERT INTO freinage(id, nom) VALUES (default, ?) ON CONFLICT(nom) DO UPDATE SET etat=? RETURNING id";
    ...
    public void update(Connection connection) throws SQLException {
        ...
        String sql = "UPDATE freinage SET nom=? WHERE id=?";
    ...
    public void delete(int id, Connection connection) throws SQLException {
        ...
        String sql = "UPDATE freinage SET etat=? WHERE id=?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
